...
void loop() {
  ...
  int turnRightRudder = 90  ;  //orientation of the servo when turning right
...
//      Serial3.println("CONVEYOR STOP");
  ...
  //imuSensor this code will print roll pitch yaw and the voltage and current of the battery if the imuSensor state is HIGH with an interval of 500 milliseconds
...
//  for gpsSensor, this code will print the latitude, longitude, and speed of the USV with an interval of 1second
