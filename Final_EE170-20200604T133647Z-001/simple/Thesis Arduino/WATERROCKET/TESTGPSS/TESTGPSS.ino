...
void loop(){
 ...
 Serial.print(",");
 Serial1.print(compAngleX);
 Serial1.print(",");
 Serial.println(compAngleY);
 Serial1.println(compAngleY);
...
void getGPS(){
 ...
 //Now begins the main loop. 
  ...
  val = map(compAngleX, -180, 180, 180, 0);
  servo1.write(val);
  servo2.write(val);
  servo3.write(val);
  servo4.write(val);
