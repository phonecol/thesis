...
% Last Modified by GUIDE v2.5 11-Mar-2021 14:21:26
...
s = sprintf('RIGHT');
set(handles.right, 'TooltipString', s)
s = sprintf('LEFT');
set(handles.left, 'TooltipString', s)
s = sprintf('CENTER');
     ...
     disp(serial_data)
        ...
        switch tag
            ...
            case '$IMU'
                ...
                IMU_data(cnt2,7) = str2double(IMU(1,6))-0.60;%vs
...
function Capture_Callback(hObject, eventdata, handles)
    ...
    Image = frame2im(F);
    savename= strcat ('C:\Users\Lenovo\Documents\People Power\Pictures\', num2str(fulldate), '.jpg');
...
if ispushed
    set(hObject, 'String', 'STOP');
    set(handles.speedstat,'string',1);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
f= msgbox({'For keyboard shortcuts:' ; '' ; 'Rudder Left = A'; 
  'Rudder Right = D' ; 'Rudder Center = Q' ; 'Move/Stop = S'
  ; 'Change state of Conveyor = C'});
...
switch keyPressed
    ...
    case 'C'
        conveyor_Callback(handles.conveyor,[],handles);   
end       
